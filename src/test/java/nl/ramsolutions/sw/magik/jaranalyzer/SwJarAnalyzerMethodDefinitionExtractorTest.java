...
/** Tests for {@link SwJarAnalyzerMethodDefinitionExtractor}. */
class SwJarAnalyzerMethodDefinitionExtractorTest {
  ...
  void testExtractMethodDefinitions() throws IOException {
    ...
    final Collection<MethodDefinition> methodDefinitions =
        SwJarAnalyzerMethodDefinitionExtractor.extractMethodDefinitions(classNode);
