...
/** Tests for {@link SwJarAnalyzerDependencyBuilder}. */
class SwJarAnalyzerDependencyBuilderTest {
  ...
  void testBuildMethodDependencyMapChar16Vector1() throws IOException {
    ...
    final Map<MethodNode, MethodNode> methodDependencyMap =
        SwJarAnalyzerDependencyBuilder.buildMethodDependencyMap(
            primaryClassNode, subsidiaryClassNode);
  ...
  void testBuildMethodDependencyMapChar16Vector2() throws IOException {
    ...
    final Map<MethodNode, MethodNode> methodDependencyMap =
        SwJarAnalyzerDependencyBuilder.buildMethodDependencyMap(
            subsidiaryClassNode, subsidiaryClassNode);
    this.assertMappingContainsOnly(
        methodDependencyMap,
        Map.entry("__loopbody_", "char16_vector__method1"),
        Map.entry("__loopbody_2", "char16_vector__method12"));
