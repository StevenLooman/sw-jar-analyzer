...
import nl.ramsolutions.sw.magik.jaranalyzer.helpers.MethodNodeHelper;
...
final class SwJarAnalyzerMethodDefinitionExtractor {
  ...
  private SwJarAnalyzerMethodDefinitionExtractor() {}
  ...
  static Collection<MethodDefinition> extractMethodDefinitions(final ClassNode classNode) {
    ...
    return Arrays.stream(executeMethodNode.instructions.toArray())
        ...
        .filter(SwJarAnalyzerMethodDefinitionExtractor::isCreateMethodCall)
        .map(
            methodInsnNode ->
                SwJarAnalyzerMethodDefinitionExtractor.extractMethodDefinition(
                    classNode, methodInsnNode))
        .toList();
  }
  ...
  private static MethodDefinition extractMethodDefinition(
    ...
    final List<LdcInsnNode> ldcNodes =
        SwJarAnalyzerMethodDefinitionExtractor.getLdcNodes(methodInsnNode);
    ...
    final List<Integer> flagValues =
        SwJarAnalyzerMethodDefinitionExtractor.getIconstValues(methodInsnNode);
