        ...
        .map(
            primaryClassNode -> {
              final String subsidiaryClassName =
                  SwJarAnalyzerDependencyBuilder.getSubsidiaryClassName(primaryClassNode);
  ...
  public static Map<MethodNode, MethodNode> buildMethodDependencyMap(
    ...
    if (executeMethodNode != null) {
      ...
      final Collection<MethodDefinition> methodDefinitions =
          SwJarAnalyzerMethodDefinitionExtractor.extractMethodDefinitions(providerClassNode);
