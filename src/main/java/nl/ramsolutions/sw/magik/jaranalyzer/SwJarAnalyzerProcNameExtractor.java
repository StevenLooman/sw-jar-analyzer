...
final class SwJarAnalyzerProcDefinitionExtractor {
  ...
  private SwJarAnalyzerProcDefinitionExtractor() {}
  ...
  static Collection<ProcDefinition> extractProcDefinitions(final ClassNode classNode) {
    ...
    return Arrays.stream(executeMethodNode.instructions.toArray())
        ...
        .filter(SwJarAnalyzerProcDefinitionExtractor::isCreateProcCall)
